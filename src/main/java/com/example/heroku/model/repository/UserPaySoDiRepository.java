...
public interface UserPaySoDiRepository extends ReactiveCrudRepository<UserPaySoDi, Long> {
    ...
    Mono<UserPaySoDi> saveTransaction(@Param("group_id")String groupID, @Param("amount") float amount, @Param("note") String note, @Param("plan") String plan, @Param("bonus") int bonus, @Param("createat") Timestamp createat);
