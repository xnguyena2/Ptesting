...
public interface BeerUnitRepository extends ReactiveCrudRepository<ProductUnit, Long> {
    ...
    @Query(value = "UPDATE product_unit SET inventory_number = :inventory_number, enable_warehouse = :enable_warehouse, arg_action_id = :arg_action_id, arg_action_type = :arg_action_type  WHERE product_unit.group_id = :group_id AND product_unit.product_second_id = :product_second_id AND product_unit.product_unit_second_id = :product_unit_second_id")
    Mono<ProductUnit> updateInventoryAndEnableWarehouse(@Param("group_id")String groupID, @Param("product_second_id")String product_second_id, @Param("product_unit_second_id")String product_unit_second_id, @Param("inventory_number") int inventory_number, @Param("enable_warehouse") boolean enable_warehouse, @Param("arg_action_id")String arg_action_id, @Param("arg_action_type")String arg_action_type);
