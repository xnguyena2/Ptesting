...
public interface BeerRepository extends ReactiveCrudRepository<Product, String> {
    ...
    @Query(value = "INSERT INTO product( group_id, product_second_id, name, detail, category, meta_search, status, createat ) VALUES ( :group_id, :product_second_id, :name, :detail, :category, :meta_search, :status, :createat ) ON CONFLICT (product_second_id) DO UPDATE SET group_id = :group_id, product_second_id = :product_second_id, name = :name, detail = :detail, category = :category, meta_search = :meta_search, status = :status, createat = :createat")
