...
public interface BeerRepository extends ReactiveCrudRepository<Product, String> {
    ...
    @Query(value = "SELECT * FROM product WHERE product.beer_second_id = :id")
    Mono<Product> findBySecondID(@Param("id")String id);

    @Query(value = "SELECT * FROM product WHERE product.beer_second_id = :id AND (product.status IS NULL OR (product.status != 'SOLD_OUT' AND product.status != 'HIDE'))")
    Mono<Product> findBySecondIDCanOrder(@Param("id")String id);

    @Query(value = "DELETE FROM product WHERE product.beer_second_id = :id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    Flux<Product> adminGetAllBeerSortByPriceASC(@Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer GROUP BY product.beer_second_id ORDER BY price DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    Flux<Product> adminGetAllBeerSortByPriceDESC(@Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    Flux<Product> adminGetAllBeerSortBySoldDESC(@Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer WHERE (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id WHERE (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer WHERE product.category = :category GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id WHERE product.category = :category GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer WHERE product.category = :category AND (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id WHERE product.category = :category AND (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) LIMIT :size OFFSET (:page*:size)")
    Flux<Product> adminSearchBeer(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT beer_s.beer_second_id, MAX(product_unit.price) AS price FROM (SELECT product.beer_second_id FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search)) beer_s LEFT JOIN product_unit ON beer_s.beer_second_id = product_unit.beer GROUP BY beer_s.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    Flux<Product> adminSearchBeerSortByPriceASC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT beer_s.beer_second_id, MAX(product_unit.price) AS price FROM (SELECT product.beer_second_id FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search)) beer_s LEFT JOIN product_unit ON beer_s.beer_second_id = product_unit.beer GROUP BY beer_s.beer_second_id ORDER BY price DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    Flux<Product> adminSearchBeerSortByPriceDESC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) ORDER BY name ASC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> adminSearchBeerSortByNameASC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) ORDER BY name DESC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> adminSearchBeerSortByNameDESC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search)  ORDER BY createat ASC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> adminSearchBeerSortByCreateASC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search)  ORDER BY createat DESC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> adminSearchBeerSortByCreateDESC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT beer_s.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold from (SELECT product.beer_second_id FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search)) beer_s LEFT JOIN product_unit_order ON beer_s.beer_second_id = product_unit_order.beer_second_id GROUP BY beer_s.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp LEFT JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE') LIMIT :size OFFSET (:page*:size)")
    Flux<Product> searchBeer(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT beer_s.beer_second_id, MAX(product_unit.price) AS price FROM (SELECT product.beer_second_id FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE')) beer_s LEFT JOIN product_unit ON beer_s.beer_second_id = product_unit.beer GROUP BY beer_s.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE') ORDER BY name ASC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> searchBeerSortByNameASC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE') ORDER BY name DESC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> searchBeerSortByNameDESC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE') ORDER BY createat ASC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> searchBeerSortByCreateASC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT * FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE') ORDER BY createat DESC LIMIT :size OFFSET (:page*:size)")
    Flux<Product> searchBeerSortByCreateDESC(@Param("search")String search, @Param("page")int page, @Param("size")int size);

    @Query(value = "SELECT product.* FROM (SELECT beer_s.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold from (SELECT product.beer_second_id FROM product INNER JOIN search_token ON search_token.beer_second_id = product.beer_second_id WHERE search_token.tokens @@ to_tsquery(:search) AND (product.status IS NULL OR product.status != 'HIDE')) beer_s LEFT JOIN product_unit_order ON beer_s.beer_second_id = product_unit_order.beer_second_id GROUP BY beer_s.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp LEFT JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer WHERE product.meta_search LIKE :search GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id WHERE product.meta_search LIKE :search GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, MAX(product_unit.price) AS price FROM product LEFT JOIN product_unit ON product.beer_second_id = product_unit.beer WHERE product.meta_search LIKE :search AND (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY price ASC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
    ...
    @Query(value = "SELECT product.* FROM (SELECT product.beer_second_id, CASE WHEN SUM(product_unit_order.number_unit) IS NULL THEN 0 ELSE SUM(product_unit_order.number_unit) END AS sold FROM product LEFT JOIN product_unit_order ON product.beer_second_id = product_unit_order.beer_second_id WHERE product.meta_search LIKE :search AND (product.status IS NULL OR product.status != 'HIDE') GROUP BY product.beer_second_id ORDER BY sold DESC LIMIT :size OFFSET (:page*:size)) beer_temp INNER JOIN product ON product.beer_second_id = beer_temp.beer_second_id")
