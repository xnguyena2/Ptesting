...
public interface AreJoinTableAndPackageDetailRepository extends ReactiveCrudRepository<AreJoinTable, Long> {
    ...
    Flux<AreJoinTable> findByID(@Param("group_id")String groupID, @Param("area_id")String areID, @Param("status") UserPackageDetail.Status status);
