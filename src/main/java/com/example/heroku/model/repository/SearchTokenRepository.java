...
public interface SearchTokenRepository extends ReactiveCrudRepository<SearchToken, Long> {
    ...
    @Query(value = "INSERT INTO search_token(group_id, product_second_id, tokens, createat) VALUES ( :group_id, :product_second_id, to_tsvector(:tokens), :createat ) ON CONFLICT (group_id, product_second_id) DO UPDATE SET tokens = to_tsvector(:tokens), createat = :createat")
