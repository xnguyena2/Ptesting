...
public interface UserPackageRepository extends ReactiveCrudRepository<UserPackage, Long> {
    ...
    Mono<UserPackage> InsertOrUpdatePackage(@Param("group_id") String groupID, @Param("device_id") String device_id, @Param("package_second_id") String package_second_id,
                                            ...
                                            @Param("buy_price") float buy_price, @Param("price") float price, @Param("discount_amount") float discount_amount, @Param("discount_percent") float discount_percent,
                                            @Param("note") String note, @Param("status") UserPackageDetail.Status status, @Param("createat") Timestamp createat);

    @Query(value = "INSERT INTO user_package(group_id, device_id, package_second_id, product_second_id, product_unit_second_id, number_unit, buy_price, price, discount_amount, discount_percent, note, status, createat) VALUES (:group_id, :device_id, :package_second_id, :product_second_id, :product_unit_second_id, :number_unit, :buy_price, :price, :discount_amount, :discount_percent, :note, :status, :createat) ON CONFLICT (group_id, package_second_id, product_second_id, product_unit_second_id) DO UPDATE SET number_unit = user_package.number_unit + :number_unit, buy_price = :buy_price, price = :price, discount_amount = :discount_amount, discount_percent = :discount_percent, note = :note, status = :status")
