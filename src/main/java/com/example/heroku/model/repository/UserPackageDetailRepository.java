...
public interface UserPackageDetailRepository extends ReactiveCrudRepository<UserPackageDetail, String> {
    @Query(value = "INSERT INTO user_package_detail(group_id, device_id, package_second_id, package_type, voucher, price, discount_amount, discount_percent, ship_price, note, image, progress, status, createat) VALUES (:group_id, :device_id, :package_second_id, :package_type, :voucher, :price, :discount_amount, :discount_percent, :ship_price, :note, :image, :progress, :status, :createat) ON CONFLICT (group_id, device_id, package_second_id) DO UPDATE SET package_type = :package_type, voucher = :voucher, price = :price, discount_amount = :discount_amount, discount_percent = :discount_percent, ship_price = :ship_price, note = :note, image = :image, progress = :progress, status = :status")
