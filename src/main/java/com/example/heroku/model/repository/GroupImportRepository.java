...
public interface GroupImportRepository extends ReactiveCrudRepository<GroupImport, Long> {
    ...
    @Query(value = "INSERT INTO group_import( group_id, group_import_second_id, supplier_id, supplier_name, supplier_phone, total_price, total_amount, payment, discount_amount, discount_percent, additional_fee, progress, note, images, type, status, createat ) VALUES ( :group_id, :group_import_second_id, :supplier_id, :supplier_name, :supplier_phone, :total_price, :total_amount, :payment, :discount_amount, :discount_percent, :additional_fee, :progress, :note, :images, :type, :status, :createat ) ON CONFLICT (group_id, group_import_second_id) DO UPDATE SET supplier_id = :supplier_id, supplier_name = :supplier_name, supplier_phone = :supplier_phone, total_price = :total_price, total_amount = :total_amount, payment = :payment, discount_amount = :discount_amount, discount_percent = :discount_percent, additional_fee = :additional_fee, progress = :progress, note = :note, images = :images, type = :type, status = :status, createat = :createat ")
