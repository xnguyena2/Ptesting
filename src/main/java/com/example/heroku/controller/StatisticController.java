...
public class StatisticController {
    ...
    public Flux<ProductOrderStatus> getbyproductid(@RequestBody @Valid SearchQuery query) {
    ...
    @CrossOrigin(origins = Util.HOST_URL)
    public Flux<ProductOrderStatus> getAll(@RequestBody @Valid SearchQuery query) {
